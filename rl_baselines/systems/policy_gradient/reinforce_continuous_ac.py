...
from .losses import BellmanDelta, ReinforceContinuousWithActorCriticLoss
...
class ReinforceContinuousWithActorCriticSystem(RLBaseSystem):
    def __init__(
        ...
        self.policy = TensorDictSequential(
            self.mean_module, self.std_module, self.critic_module, self.action_sampler
        )
    ...
    def training_step(self, batch, batch_idx):
        ...
        _ = self.cfg.data.batch_size
        _ = self.cfg.trainer.epochs_per_episode
